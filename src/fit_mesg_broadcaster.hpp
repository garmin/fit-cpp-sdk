...
#include "fit_battery_mesg_listener.hpp"
...
public:
    ...
    void AddListener(BatteryMesgListener& batteryMesgListener);
    void RemoveListener(BatteryMesgListener& batteryMesgListener);
...
private:
    ...
    std::vector<BatteryMesgListener *> batteryMesgListeners;
